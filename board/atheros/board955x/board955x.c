...
{
    if ((ath_reg_rd (GPIO_OUT_ADDRESS) & (1 << 16)) == 0) {
...
void ath_gpio_config(void)
{
	...
	ath_reg_rmw_set(GPIO_OE_ADDRESS, (1 << 4));
       ...
       /*
	Open-Mesh A-Series(A40,A60) GPIO Assignments
	-----------------------------------
	Pins		   Desc.
	-----------------------------------
	13		2G_WLAN_LED
	16		WatchDog_CLK_INPUT
	17		Reset_Button
	20		WatchDog_Enable
	22		POWER_LED
	23		5G_WLAN_LED
	-----------------------------------
       */
       ...
       ath_reg_rmw_clear(GPIO_OE_ADDRESS, (1 << 22));
       ath_reg_rmw_clear(GPIO_OE_ADDRESS, (1 << 23));

       ath_reg_rmw_clear(GPIO_OUT_ADDRESS, (1 << 16));
       ath_reg_rmw_set(GPIO_OUT_ADDRESS, (1 << 13));
       ath_reg_rmw_clear(GPIO_OUT_ADDRESS, (1 << 20));	
       ath_reg_rmw_set(GPIO_OUT_ADDRESS, (1 << 22));
       ath_reg_rmw_clear(GPIO_OUT_ADDRESS, (1 << 23));
#endif
}
