...
void wasp_gpio_config(void)
{
	...
	ar7240_reg_rmw_clear(0x18040030, 0x000000ff);
	ar7240_reg_rmw_clear(0x18040034, 0xff000000);
	ar7240_reg_rmw_clear(0x18040038, 0xffffffff);
	ar7240_reg_rmw_clear(0x1804003c, 0xff00ffff);
	ar7240_reg_rmw_clear(0x18040040, 0x00ff0000);
	ar7240_reg_rmw_set(0x18040038, 0x292d0000);
	ar7240_reg_rmw_clear (AR7240_GPIO_OE, 0x4bf800);
	ar7240_reg_rmw_clear (AR7240_GPIO_OUT, 0x40e000);
	ar7240_reg_rmw_set (AR7240_GPIO_OUT, 0xb0000);
#endif
}
...
{
    if ((ar7240_reg_rd (AR7240_GPIO_OUT) & 0x800) == 0) {
        ar7240_reg_rmw_set (AR7240_GPIO_OUT, 0x800);
    }
    else {
        ar7240_reg_rmw_clear (AR7240_GPIO_OUT, 0x800);
    }
}
