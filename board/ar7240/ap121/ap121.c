...
void ar7240_gpio_config(void)
{
    ...
    ar7240_reg_rmw_set (HORNET_BOOTSTRAP_STATUS, 0x40000);
    ar7240_reg_rmw_clear (AR7240_GPIO_FUNC, 0x70);
    ar7240_reg_rmw_set (AR7240_GPIO_OE, 0xc03f003);
    ar7240_reg_rmw_clear (AR7240_GPIO_OUT, 0xc022002);
    ar7240_reg_rmw_set (AR7240_GPIO_OUT, 0x1c001);
#endif
}
...
{
    strcpy(board_string, BOARD_NAME" (OM2Pv2) U-boot");
    return 0;
}
#else
int checkboard (void)
{
    printf(BOARD_NAME" (OM2Pv2) U-boot\n");
    return 0;
}
...
{
    if ((ar7240_reg_rd (AR7240_GPIO_OUT) & 0x4000000) == 0) {
        ar7240_reg_rmw_set (AR7240_GPIO_OUT, 0x4000000);
    }
    else {
        ar7240_reg_rmw_clear (AR7240_GPIO_OUT, 0x4000000);
    }
}
...
int gpio_custom (int opcode)
{
    ...
    switch (opcode) {
        case 0:
            if ((ar7240_reg_rd (AR7240_GPIO_IN) & 0x1000) == 0) {
                cmd = 0;
            }
            else {
                cmd = -1;
